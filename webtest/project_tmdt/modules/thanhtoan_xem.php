...
<?php
	...
	if(!isset($Email)){
		header("location: ?m=dangnhap&chuyenhuong=thanhtoan");
	}
...
?>
    ...
    <div class="col_min">
      ...
      <div id="table" style="width:100%; display:inline-block; height:auto;">
        ...
        <ul class="forms">                   	    	
                ...
                <li><label class="button bold "><a href="?m=giohang">&nbsp;&nbsp;Thêm số lượng&nbsp;&nbsp;</a></label></li>
            </ul>
      </div>
      <?php
		}else{
  ...
  <div class="col_min">
          <h1 class="heading title"  style="text-align:right;">Thông tin cá nhân</h1>
          <?php
        ...
        <div id="table" style="width:360px; height:360px; float:left">
              ...
              <ul class="forms">
                  <li class="txt">Họ và tên <span class="req">*</span></li>
                  <li class="inputfield"><input type="text" value="<?php echo $HoTenNN?>" name="HoTen" id="HoTen" /></li>
              </ul>
              <ul class="forms">
                <li class="txt">Địa chỉ mail <span class="req">*</span></li>
                  <li class="inputfield"><input type="email" value="<?php echo $Email?>" name="Email" id="Email" /></li>
              </ul>
              <ul class="forms">
                  <li class="txt">Số điện thoại <span class="req">*</span></li>
              ...
              <ul class="forms">
                  <li class="txt">Địa chỉ <span class="req">*</span></li>
                  <li class="inputfield"><input type="text" value="<?php echo $DiaChi?>" name="DiaChi" id="DiaChi" /></li>
              </ul>
              <ul class="forms">
                  <li class="txt">Ngày nhận <span class="req">*</span></li>
                  <li class="inputfield"><input type="text" value="<?php echo $NgayNhan?>" readonly name="NgayNhan" id="NgayNhan" onfocus="scwShow(this,event);" onclick="scwShow(this,event);" /></li>
                  <script>
              ...
              <ul class="forms">
                  ...
                  <li class="inputfield">
                    <textarea name="GhiChu" id="GhiChu" style="height:70px;"><?php echo $GhiChu?></textarea>
                  </li>
              </ul>
            <ul class="forms">
            ...
            <ul class="forms">
              <li class="txt">&nbsp;<input type="submit" id="submitLH" class="none" /></li>
                  <li><label class="button bold right"><a href="javascript:void(1);" onclick="document.getElementById('formTT').submit()" >&nbsp;&nbsp;Thanh toán&nbsp;&nbsp;</a></label></li>
              </ul>
          </div>
          </form>
    </div><!-- end col_min -->
