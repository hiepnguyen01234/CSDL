  ...
  <div class="col_min">
        ...
        <div id="table" style="width:360px; height:360px; float:left">
              ...
              <ul class="forms">
                  ...
                  <li class="inputfield"><input type="text" value="<?php echo date('d/m/Y', time()+3600*24*3)?>" readonly name="NgayNhan" id="NgayNhan" onfocus="scwShow(this,event);" onclick="scwShow(this,event);" /></li>
                  <script>
